...
class LoadContratarB extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
    ...
    public function load(ObjectManager $manager) {
        $Entidades = $manager->getRepository('TodoBundle:Entidades')->findAll();
        $Persona = $manager->getRepository('TodoBundle:Persona')->findBy(array('peCedula' => '1500583339'));
        foreach ($Entidades as $e_es):
            switch ($e_es->getEsAlias()):
                case 'Banco Pichincha':
                    ...
                    foreach ($ContratarB as $c_b):
                        ...
                        $cb->setCbFechaBorrado($c_b['cb_fecha_borrrado']);
                        $cb->setCbQuienBorra($c_b['cb_quien_borra']);
                        $cb->setCbBorradoLogico($c_b['cb_borrado_logico']);
                        $cb->setPersonaPe(reset($Persona));
                        $cb->setEntidadesEs($e_es);
                        $manager->persist($cb);
                    endforeach;
                break;
                ...
                case 'Produbanco':
                    $ContratarB = array(
                        array(
                            'cb_fecha_contrato' => new \DateTime('2014-06-06'),
                            'cb_fecha_crea' => new \DateTime('2014-06-07 13:46:37'),
                            'cb_quien_crea' => 1,
                            'cb_fecha_modifica' => NULL,
                            'cb_quien_modifica' => NULL,
                            'cb_fecha_borrrado' => NULL,
...
//                    $ContratarB = array(
//                        array(
//                            'cb_fecha_contrato' => new \DateTime('2014-05-19'),
//                            'cb_fecha_crea' => new \DateTime('2014-06-07 13:42:01'),
//                            'cb_quien_crea' => 1,
//                            'cb_fecha_modifica' => NULL,
//                            'cb_quien_modifica' => NULL,
//                            'cb_fecha_borrrado' => NULL,
